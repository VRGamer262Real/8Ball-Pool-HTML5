...
(loadState.init = function () {
  ...
  game.add
    ...
    .to({ alpha: 1 }, 1e3, Phaser.Easing.Linear.None, !0, 500);
}),
  ...
  (loadState.preload = function () {
    this.load.spritesheet("muteButton", "assets/img/muteButton.png", 256, 256),
      ...
      this.load.spritesheet(
        "quitButton",
        "assets/img/quitButton.png",
        256,
        256
      ),
      this.load.spritesheet(
        "replayButton",
        "assets/img/replayButton.png",
        256,
        256
      ),
      this.load.spritesheet(
        "helpButton",
        "assets/img/helpButton.png",
        256,
        256
      ),
      this.load.spritesheet(
        "statsButton",
        "assets/img/statsButton.png",
        256,
        256
      ),
      this.load.spritesheet(
      ...
      this.load.spritesheet(
        "solidsSpriteSheet",
        "assets/img/solidsSpriteSheet.png",
        48,
        48,
        9
      ),
      this.load.spritesheet(
        "ballSpriteSheet9",
        "assets/img/ballSpriteSheet9.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet10",
        "assets/img/ballSpriteSheet10.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet11",
        "assets/img/ballSpriteSheet11.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet12",
        "assets/img/ballSpriteSheet12.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet13",
        "assets/img/ballSpriteSheet13.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet14",
        "assets/img/ballSpriteSheet14.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "ballSpriteSheet15",
        "assets/img/ballSpriteSheet15.png",
        50,
        50,
        41
      ),
      this.load.spritesheet(
        "spotSpriteSheet",
        "assets/img/spotSpriteSheet.png",
        38,
        38,
        16
      ),
      this.load.spritesheet(
        "bonusStarSpriteSheet",
        "assets/img/bonusStar.png",
        59,
        67,
        1.5
      ),
      ...
      this.load.spritesheet(
        "illegalContacts",
        "assets/img/illegalContacts.png",
        345,
        137
      ),
      this.load.spritesheet(
        "illegalShots",
        "assets/img/illegalShots.png",
        324,
        324
      ),
      ...
      game.load.bitmapFont(
        "font5",
        "assets/fonts/font5.png",
        "assets/fonts/font5.fnt"
      ),
      game.load.bitmapFont(
        "font6",
        "assets/fonts/font6.png",
        "assets/fonts/font6.fnt"
      ),
      game.load.bitmapFont(
        "font7",
    ...
    this.load.image(
      "panel4",
      e ? "assets/img/panel4e.png" : "assets/img/panel4d.png"
    ),
      ...
      this.load.audio("ballHit", [
        "assets/audio/ballHit2.wav",
        "assets/audio/ballHit2.mp3",
      ]),
      this.load.audio("cushionHit", [
        "assets/audio/cushionHit.wav",
        "assets/audio/cushionHit.mp3",
      ]),
      this.load.audio("pocketHit", [
        "assets/audio/pocketHit.wav",
        "assets/audio/pocketHit.mp3",
      ]),
      this.load.audio("cueHit", [
        "assets/audio/cueHit.wav",
        "assets/audio/cueHit.mp3",
      ]),
      this.load.audio("shimmer", [
        "assets/audio/shimmer.wav",
        "assets/audio/shimmer.mp3",
      ]),
      this.load.audio("ding", [
        "assets/audio/ding.wav",
        "assets/audio/ding.mp3",
      ]),
      this.load.audio("cheer", [
        "assets/audio/cheer.wav",
