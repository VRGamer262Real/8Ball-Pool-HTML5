...
(Ball.prototype = Object.create(Phaser.Group.prototype)),
  ...
  (Ball.prototype.updateRotation = function (t, s, h) {
    ...
    r > 0.01 &&
      ((this.ballRotation = this.rotateQuat(
        this.ballRotation,
        a / r,
        i / r,
        o / r,
  ...
  (Ball.prototype.renderBall = function (t) {
    var s = t[0],
      ...
      a = t[3],
      o =
        Math.atan2(2 * s * a - 2 * h * i, 1 - 2 * s * s - 2 * i * i) + Math.PI,
      r = Math.asin(2 * h * s + 2 * i * a) + Math.PI,
      e =
        Math.atan2(2 * h * a - 2 * s * i, 1 - 2 * h * h - 2 * i * i) + Math.PI,
      l = h * s + i * a;
    if (!(l > 0.499 || l < -0.499)) {
      if (
      ...
      var n =
          Math.sqrt(
            this.spotHolder.x * this.spotHolder.x +
              this.spotHolder.y * this.spotHolder.y
          ) / this.circRad,
