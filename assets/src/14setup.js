        ...
        if ("portrait" == window.famobi.getOrientation()) {
          ...
          (e.playButtonPU.x = 0),
            ...
            "STRIPES" == e.p1TargetType &&
              ((e.rackSolids.y = game.height - 10),
              (e.rackStripes.y = game.height - 100)),
          ...
          (e.landscape = !0),
            ...
            "SOLIDS" == e.p1TargetType &&
              ...
              (e.rackStripes.x = (3 * game.width) / 4)),
            "STRIPES" == e.p1TargetType &&
              ((e.rackSolids.x = (3 * game.width) / 4),
              (e.rackStripes.x = game.width / 4)),
    ...
    (e.adjustmentScale = 2.3),
      ...
      (function () {
        (e.bgCanvas = new Phaser.Group(game, game.stage, "bgCanvas")),
          (e.guiBaseCanvas = new Phaser.Group(
            game,
            game.stage,
            "guiBaseCanvas"
          )),
        ...
        game.add
          .tween(e.cueBaseCanvas)
          .from({ alpha: 0 }, 1e3, Phaser.Easing.Linear.None, !0, 500),
          game.add
            .tween(e.guiCanvas)
            .from({ alpha: 0 }, 1e3, Phaser.Easing.Linear.None, !0, 500),
          game.add
      ...
      (function () {
        ...
        (e.pocketArray = new Array()),
          ...
          (t.dropPosition = new Vector2D(
            -51 * n - e.pocketRadius / 2,
            -26 * n - e.pocketRadius / 4
          )),
          (t.starPosition = new Vector2D(
            -50.4 * n - e.pocketRadius / 2,
            -25.8 * n - e.pocketRadius / 4
          )),
          (t.id = 0),
          ...
          (t.starPosition = new Vector2D(
            -50.3 * n - e.pocketRadius / 2,
            25.5 * n + e.pocketRadius / 4
          )),
          (t.id = 3),
          e.pocketArray.push(t),
          ((t = new Object()).position = new Vector2D(
        ...
        for (var r = 0; r < e.lineArray.length; r++) {
          var o;
          ((o = e.lineArray[r]).direction = new Vector2D(
            o.p2.x - o.p1.x,
            o.p2.y - o.p1.y
          ).normalize()),
      ...
      (function () {
        (e.debugText = new Phaser.BitmapText(
          game,
          game.width - 1,
          20,
          "font7",
          ...
          (e.cueBallSpotZoom = new Phaser.Sprite(
            game,
            0,
            0,
            "cueBallSpotZoom"
        ...
        for (var i = 0; i < 7; i++)
          (e.rackSolidsArray[i] = new Phaser.Sprite(
            game,
            0,
            0,
            "guiSolids",
        ...
        for (i = 0; i < 7; i++) {
          (e.rackStripesArray[i] = new Phaser.Sprite(
            game,
            0,
            0,
            "guiStripes",
        ...
        if (
          ...
          ((l = new Phaser.BitmapText(
            game,
            124,
            -(e.humanIcon.height - 204),
            "font7",
            "1",
            80
        ...
        if (
          ...
          (e.aiIcon = new Phaser.Sprite(game, 0, 0, "humanIcon")),
            ((c = new Phaser.BitmapText(
              game,
              124,
              -(e.humanIcon.height - 81),
              "font7",
              "2",
              80
            )).anchor = new Phaser.Point(0.5, 0.5)),
        ...
        e.guiCanvas.addChild(e.aiIcon),
          ...
          (e.timerText = new Phaser.BitmapText(
            game,
            0,
            0,
            "font7",
          ...
          (window.gi = e),
          (e.scoreText = new Phaser.BitmapText(
            game,
            0,
            0,
            "font7",
          ...
          (e.multiplierText = new Phaser.BitmapText(
            game,
            0,
            0,
            "font7",
        ...
        (e.menuButton = new Phaser.Button(
          game,
          0,
          0,
          "menuButton",
        ...
        (e.gameOverPanel = new Phaser.Group(
          game,
          e.guiCanvas,
          "gameOverPanel"
        )),
        ...
        (e.p1Icon = new Phaser.Sprite(game, s.x, s.y, "humanIcon")),
          ...
          ((l = new Phaser.BitmapText(game, -4, 81, "font7", "1", 80)).anchor =
            new Phaser.Point(0.5, 0.5)),
          (l.tint = 0),
          e.p1Icon.addChild(l),
          ((u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor =
            new Phaser.Point(0.5, 0.5)),
        ...
        (e.p2Icon = new Phaser.Sprite(game, p.x, p.y, "humanIcon")),
          ...
          ((c = new Phaser.BitmapText(game, -4, 81, "font7", "2", 80)).anchor =
            new Phaser.Point(0.5, 0.5)),
          (c.tint = 0),
          e.p2Icon.addChild(c),
          ((u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor =
          ...
          (e.p2Icon.rosette = u),
          (e.p2Icon.visible = !1),
          (e.gameOverPanel.text1 = new Phaser.BitmapText(
            game,
            0,
            -180,
            "font7",
          ...
          (e.gameOverPanel.text2 = new Phaser.BitmapText(
            game,
            0,
            -209,
            "font7",
          ...
          (e.gameOverPanel.text3 = new Phaser.BitmapText(
            game,
            -110,
            -28,
            "font7",
          ...
          (e.gameOverPanel.text4 = new Phaser.BitmapText(
            game,
            135,
            -28,
            "font7",
        ...
        (e.quitButton2 = new Phaser.Button(
          game,
          90,
          170,
          "quitButton",
          ...
          (e.replayButton = new Phaser.Button(
            game,
            -90,
            170,
            "replayButton",
          ...
          (e.quitButtonPU = new Phaser.Button(
            game,
            -57,
            0,
            "quitButton",
          ...
          (e.replayButtonPU = new Phaser.Button(
            game,
            -170,
            0,
            "replayButton",
          ...
          (e.muteButtonPU = new Phaser.Button(
            game,
            57,
            0,
            "muteButton",
        ...
        (e.quitButtonPU.input.enabled = !1),
          ...
          (e.foulWindow.background = new Phaser.Sprite(
            game,
            0,
            0,
            "foulDisplay"
          ...
          (e.foulWindow.display1 = new Phaser.Sprite(
            game,
            -172,
            -126,
            "illegalContacts"
        ...
        (h.anchor = new Point(0.5, 0)),
          ...
          (e.foulWindow.display2 = new Phaser.Sprite(
            game,
            -172,
            30,
            "illegalContacts"
        ...
        (d.anchor = new Point(0.5, 0)),
          ...
          (e.foulWindow.display3 = new Phaser.Sprite(
            game,
            0,
            0,
            "illegalShots"
          ...
          (e.foulWindow.display4 = new Phaser.Sprite(
            game,
            0,
            0,
            "illegalBreak"
          ...
          (e.foulWindow.highlight = new Phaser.Sprite(
            game,
            -262,
            -237,
            "foulHighlight"
      ...
      renderScreen(),
      (function () {
        (e.levelText = new Phaser.BitmapText(
          game,
          0,
          -100,
          "font1",
      ...
      (function () {
        (e.tutorialText = new Phaser.BitmapText(
          game,
          0,
          0,
          "font3",
