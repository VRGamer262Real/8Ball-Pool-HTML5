function onContact(e) {
  ...
  "ball" == a.collisionType) &&
    ...
    0 == o.trial &&
      ((t = i.velocity.minus(i.targetVelocity).magnitude / 6e3) > 1 && (t = 1),
...
function playPocketAnimation(e) {
  ...
  if (0 == t.trial) {
    ...
    (o.pocketTweenComplete = !1),
      0 != o.id
        ? (o.shadow.parent.removeChild(o.shadow), (o.shadow = null))
        : (o.shadow.visible = !1);
    var i = 0.1;
    l < 5e3 && (i = 0.2),
      l < 3e3 && (i = 0.3),
    ...
    n.to(
      { x: a.dropPosition.x * t.physScale, y: a.dropPosition.y * t.physScale },
      i
    ),
      n.onComplete.add(function () {
        var e = o.mc.x,
          a = o.mc.y;
        t.ballCanvas.removeChild(o.mc),
          t.tunnelCanvas.addChild(o.mc),
          (o.mc.x = e),
          (o.mc.y = a),
          c.start();
      }, this),
    ...
    c.to(
      {
        x: 0.7 * a.dropPosition.x * t.physScale,
        y: 0.7 * a.dropPosition.y * t.physScale,
      },
      1.2 * i,
