!(function (E, e) {
  var t = {
    ...
    trackStats: function (E, e, n) {
      return new Promise(function (r, S) {
        ...
        if (
          ...
          return S("trackStats(): invalid params " + JSON.stringify(E, e)), !1;
        var i = function (E, e) {
          if ("string" == typeof E && E.length)
            return (
              E in t.stats && null == e
                ? delete t.stats[E]
                : void 0 !== e && e && (t.stats[E] = e),
              !0
            );
        ...
        if (E && "object" == typeof E) {
          for (var L in E) i(L, (e = E[L]));
          T = E;
        } else i(E, e), (T[E] = e);
        famobi.hasOwnProperty("adapters") &&
          famobi.adapters.run("analytics", "trackStats", E, e, n),
          r(T);
      });
    },
    getStats: function () {
    ...
    trackEvent: function (E, e) {
      return new Promise(function (n, r) {
        if (void 0 === t[E])
          return r("trackEvent(): unknown event '" + E + "'"), !1;
        if ("object" != typeof (e = e || {}) && null !== e)
          return r("trackEvent(): second parameter needs to be an object"), !1;
        if (
          !(function () {
            var t = {
                levelName: "",
            ...
            if (void 0 !== n[E] && 0 === Object.keys(e).length) return !1;
            if (void 0 === n[E]) return !0;
            for (var r = 0, S = "", T = null; r < n[E].length; r++) {
              if (
                "string" == typeof (T = t[(S = n[E][r])]) &&
                "string" != typeof e[S]
              )
                return !1;
              if ("number" == typeof T && "number" != typeof e[S]) return !1;
              if ("object" == typeof T && -1 === T.indexOf(e[S])) return !1;
            }
            return !0;
          })()
        )
          return r("trackEvent(): invalid params " + JSON.stringify(e));
        if (
          (t.events.push({ event: E, params: e }),
          famobi.hasOwnProperty("adapters") &&
            famobi.adapters.run("analytics", "trackEvent", E, e),
          t.TRIGGER_SCORE.indexOf(E) > -1)
        ) {
          if (!window.famobi.hasFeature("highscores")) return n(E, e);
          switch (E) {
            case "EVENT_LEVELSCORE":
              famobi.submitHighscore(e.levelName, e.levelScore, !0);
              break;
            case "EVENT_TOTALSCORE":
              famobi.submitHighscore("TOTAL", e.totalScore, !0);
              break;
            default:
          }
        ...
        return t.TRIGGER_LEVELSUCCESS.indexOf(E) > -1
          ? Promise.all([window.famobi.showAd()]).then(function () {
              n(E, e);
            })
          : t.TRIGGER_LEVELFAIL.indexOf(E) > -1
          ? "quit" == e.reason
            ? n(E, e)
            : Promise.all([window.famobi.showAd()]).then(function () {
                n(E, e);
              })
          : t.TRIGGER_LEVELSTART.indexOf(E) > -1
          ? Promise.all([]).then(function () {
              n(E, e);
            })
          : t.TRIGGER_LIVESCORE.indexOf(E) > -1
          ? (famobi.sendLiveScore(e.liveScore), n(E, e))
          : n(E, e);
      });
    },
    getEvents: function () {
    ...
    trackScreen: function (E, e) {
      return new Promise(function (n, r) {
        return void 0 === t[E]
          ? (r("trackScreen(): unknown screen '" + E + "'"), !1)
          : !e && E.indexOf(["SCREEN_OTHER"]) > -1
          ? (r("trackScreen(): screen '" + E + "' requires param 'pageTitle'"),
            !1)
          : e && "string" != typeof e
          ? (r(
          ...
          : ((t.currentScreen = E),
            (t.pageTitle = e),
            famobi.hasOwnProperty("adapters") &&
              famobi.adapters.run("analytics", "trackScreen", E, e),
            void n(E, e));
      });
    },
    getScreen: function () {
